...
const values = [
  ...
  {
    title: "誠実に、煽らない",
    body: "誇張より、体験・判断の経緯・失敗で語ります。差がつきにくい情報より、信頼を積みたい。",
  },
];
    ...
    <main className="mx-auto max-w-3xl px-5 py-16 sm:py-20">
      ...
      <FadeIn>
        <div className="mt-8 space-y-4 leading-relaxed text-foreground/80">
          <p>
            AIを使って、企画から制作・運用までプロダクトを形にしています。専門は
            RAG・業務自動化・AIアプリ開発。
          </p>
          <p>
            個人で事業「Nompass」（小規模事業者向けの Web × AI 支援）を立ち上げ、
            企画から制作・運用・事業化まで一人で回しています。だから「AIで何をどこまで任せ、
            どこを人が握るか」を、理論ではなく実体験で語れます。
          </p>
          <p>
            目指しているのは、会社や場所に依存せず、自分のスキルで食べていける状態。
            同じように独学・キャリアチェンジを目指す人の役に立てたら、という思いで発信もしています。
          </p>
        </div>
      </FadeIn>
