...
export default function WorkCard({ work }: { work: Work }) {
  return (
    <Link
      ...
      className="group flex h-full flex-col rounded-2xl border border-black/8 bg-white p-6 transition hover:border-brand/40 hover:shadow-lg hover:shadow-brand/5"
    >
